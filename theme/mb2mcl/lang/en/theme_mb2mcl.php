...
$string['configtitle'] = 'Macro theme settings';
...
$string['hide'] = 'Hide';
$string['icon'] = 'Icon';
$string['icondesc'] = 'Icon name, e.g. \'fa-envelope\'.';
$string['image'] = 'Image';
...
$string['mb2slider_plugin'] = '<strong>Mb2 Slider</strong> block must be installed.';
$string['mb2shortcodes_filter_plugin'] = '<strong>Mb2 Shortcodes Filter</strong> plugin must be <strong>installed</strong> and <strong><u>activated</u></strong>.';
$string['mb2shortcodes_button_plugin'] = '<strong>Mb2 Shortcodes Button</strong> plugin must be installed.';
...
$string['navclsdesc'] = 'You may set different css class for different menu items and then styled it. Use "itemLabel:cssClass", e.g. "Courses:myCustoClass". classes for each menu item must be placed in a new line.';
